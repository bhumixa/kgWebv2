...
export class GeneralInfoPage implements OnInit {
  ...
  ngOnInit() {
	...
	this.validations_form = this.formBuilder.group({
	  ...
	  rapnet: new UntypedFormControl('', Validators.compose([
        Validators.required,
...
validation_messages = {
	...
	'rapnet': [
      { type: 'required', message: 'Rapnet ID is required.' },
	  { type: 'minlength', message: 'Rapnet ID must be at least 4 characters long.' },
    ],
	'country': [
